...
if __name__ == '__main__':
    ...
    teams = {
        ...
        "Random Team": [
            ...
            RandomAgent(environment.action_space[4].n),
            RandomAgent(environment.action_space[5].n),
            RandomAgent(environment.action_space[6].n),
            RandomAgent(environment.action_space[7].n),
        ]
    }
